...
<head>
	<meta charset="UTF-8">
	<meta name="google-site-verification" content="VpB2BT30TKYN9PjEXO3b0B7te6b9UuFdRDr5-BnbfGs" />
	<link rel="icon" type="image/png" href="img/favicon.png" />
	<title>ELAS CONSTRUCTORA DEL MAYAB</title>
	 <meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0"> 
  	<META NAME="Title" content="ELAS CONSTRUCTORA DEL MAYAB en ciudad de mérida.">
  	<META NAME="Author" CONTENT="[http://elasconstructora.com/]"/>
